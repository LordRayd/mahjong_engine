...
import fr.univubs.inf1603.mahjong.engine.rules.WindHonor.Wind;
...
public class Game{
   ...
   */
  public HashMap<Integer,Wind> launchGame(){
   ...
   */
  public Board getBoard(int player) throws GameException, ZoneException{
    Board ret = this.board.getClone();
